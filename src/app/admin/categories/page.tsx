  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-medium text-zinc-900 tracking-tight">Categories</h1>
          <p className="text-zinc-500 mt-1">Manage your product categories</p>
        </div>
                ...
                categories.map((category) => (
                  <tr key={category.id} className="hover:bg-zinc-50/50 transition-colors group">
                    <td className="px-6 py-4">
                      <Link href={`/admin/categories/${category.id}/edit`} className="font-medium text-zinc-900 hover:underline">
                        {category.name}
                      </Link>
                    </td>
